...
const AdminPanel = (props) => {
  ...
  const enableUser = (username) => {
    ...
    enableAccount(username, user.jwt).then((_resp) => {
  ...
  const changeRole = (evt, username) => {
    ...
    changeAccountRole(username, role, user.jwt).then((_resp) => {
  ...
  const updateEnabledState = (user) =>
    user.enabled ? disableUser(user.username) : enableUser(user.username);
